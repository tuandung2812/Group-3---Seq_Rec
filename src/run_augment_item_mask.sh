...
python main.py --model_name GRU4Rec --epoch 2 --emb_size 64 --hidden_size 100 --lr 1e-3 --l2 1e-4 --history_max 20 --dataset 'Video_Games' --augment 'None' --train_ratio 0.1

python main.py --model_name Caser --epoch 10 --emb_size 64 --L 5 --num_horizon 64 --num_vertical 32 --lr 1e-3 --l2 1e-4 --history_max 20 --dataset 'Video_Games'

python main.py --model_name SASRec --epoch 200 --emb_size 64 --num_layers 2 --num_heads 1 --lr 1e-3 --l2 1e-6 --history_max 20 --dataset 'Video_Games' --train_ratio 0.25 --augment  'noise_injection' --early_stop 20
...
python main.py --model_name GRU4Rec --epoch --emb_size 64 --hidden_size 100 --lr 1e-3 --l2 1e-4 --history_max 20 --dataset 'Grocery_and_Gourmet_Food'
