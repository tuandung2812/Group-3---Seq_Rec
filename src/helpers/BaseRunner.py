    ...
    def train(self, data_dict: Dict[str, BaseModel.Dataset]):
        ...
        try:
            for epoch in range(self.epoch):
                ...
                self.epoch_time.append(training_time + testing_time)
...
Epoch 14    loss=0.2008 [27.9 s]    dev=(HR@5:0.5181,NDCG@5:0.3755) [1.5 s] *                       
Epoch 15    loss=0.1976 [25.8 s]    dev=(HR@5:0.5226,NDCG@5:0.3792) [1.4 s] *                       
Epoch 16    loss=0.1950 [25.2 s]    dev=(HR@5:0.5275,NDCG@5:0.3839) [1.5 s] *                       
Epoch 17    loss=0.1886 [24.5 s]    dev=(HR@5:0.5270,NDCG@5:0.3822) [1.4 s]                         
    ...
    def calculate_average_epoch_time(self):
        return sum(self.epoch_time) / len(self.epoch_time)
